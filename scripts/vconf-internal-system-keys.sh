...
/usr/bin/buxton2ctl -i -d create-int32 "memory" "memory/system/timechanged"  "0"  "http://tizen.org/privilege/internal/default/public" "http://tizen.org/privilege/internal/default/platform"
