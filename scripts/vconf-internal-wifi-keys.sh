...
/usr/bin/buxton2ctl -i -d create-int32 "system" "db/wifi/bssid_address"  "0"  "http://tizen.org/privilege/internal/default/public" "http://tizen.org/privilege/internal/default/platform"
...
# DO NOT GENERATE # /usr/bin/buxton2ctl -i -d create-int32 "" "memory/wifi_direct/transfer_state"  "0"  "" ""

# DO NOT GENERATE # /usr/bin/buxton2ctl -i -d create-int32 "" "memory/wifi_direct/share/sending_state"  "0"  "" ""

# DO NOT GENERATE # /usr/bin/buxton2ctl -i -d create-int32 "" "memory/wifi_direct/share/receiving_state"  "0"  "" ""
...
/usr/bin/buxton2ctl -i -d create-int32 "memory" "memory/wifi_direct/state"  "0"  "http://tizen.org/privilege/wifidirect" "http://tizen.org/privilege/internal/buxton/readonly"
...
/usr/bin/buxton2ctl -i -d create-int32 "system" ""  "1"  "http://tizen.org/privilege/internal/default/public" ""

/usr/bin/buxton2ctl -i -d create-int32 "system" "file/private/wifi/sort_by"  "1"  "http://tizen.org/privilege/internal/default/public" ""
