...
/usr/bin/buxton2ctl create-int32 "" "memory/telephony/sim_slot_count"  "-1"  "http://tizen.org/privilege/internal/default/public" "http://tizen.org/privilege/internal/default/platform"
