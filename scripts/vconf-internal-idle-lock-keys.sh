...
/usr/bin/buxton2ctl -i -d create-int "memory" "memory/idle_lock/state_read_only"  "0"  "http://tizen.org/privilege/internal/default/public" "http://tizen.org/privilege/internal/default/platform"
