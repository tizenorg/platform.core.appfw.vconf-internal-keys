...
/usr/bin/buxton2ctl create-int32 "memory" "memory/sysman/earjack"  "-1"  "http://tizen.org/privilege/internal/default/public" "http://tizen.org/privilege/internal/default/platform"
